...
public class com_devlomi_fireapp_model_realms_QuotedMessageRealmProxy extends com.devlomi.fireapp.model.realms.QuotedMessage
    ...
    public com.devlomi.fireapp.model.realms.Status realmGet$status() {
        ...
        return proxyState.getRealm$realm().get(com.devlomi.fireapp.model.realms.Status.class, proxyState.getRow$realm().getLink(columnInfo.statusIndex), false, Collections.<String>emptyList());
    }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("QuotedMessage", 14, 0);
    ...
    public static com.devlomi.fireapp.model.realms.QuotedMessage copy(Realm realm, QuotedMessageColumnInfo columnInfo, com.devlomi.fireapp.model.realms.QuotedMessage newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com.devlomi.fireapp.model.realms.Status statusObj = realmObjectSource.realmGet$status();
        if (statusObj == null) {
            ...
            if (cachestatus != null) {
                ...
                realmObjectCopy.realmSet$status(com_devlomi_fireapp_model_realms_StatusRealmProxy.copyOrUpdate(realm, (com_devlomi_fireapp_model_realms_StatusRealmProxy.StatusColumnInfo) realm.getSchema().getColumnInfo(com.devlomi.fireapp.model.realms.Status.class), statusObj, update, cache, flags));
            }
        }
