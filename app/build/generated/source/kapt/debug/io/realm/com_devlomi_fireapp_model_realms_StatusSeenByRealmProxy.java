...
public class com_devlomi_fireapp_model_realms_StatusSeenByRealmProxy extends com.devlomi.fireapp.model.realms.StatusSeenBy
    ...
    static final class StatusSeenByColumnInfo extends ColumnInfo {
        ...
        StatusSeenByColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.seenAtIndex = addColumnDetails("seenAt", "seenAt", objectSchemaInfo);
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.seenAtIndex = src.seenAtIndex;
    ...
    public long realmGet$seenAt() {
        proxyState.getRealm$realm().checkIfValid();
        return (long) proxyState.getRow$realm().getLong(columnInfo.seenAtIndex);
    }
    ...
    public void realmSet$seenAt(long value) {
        if (proxyState.isUnderConstruction()) {
            ...
            final Row row = proxyState.getRow$realm();
            row.getTable().setLong(columnInfo.seenAtIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setLong(columnInfo.seenAtIndex, value);
    }

    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("StatusSeenBy", 2, 0);
    ...
    private static com_devlomi_fireapp_model_realms_StatusSeenByRealmProxy newProxyInstance(BaseRealm realm, Row row) {
    ...
    public static com.devlomi.fireapp.model.realms.StatusSeenBy copy(Realm realm, StatusSeenByColumnInfo columnInfo, com.devlomi.fireapp.model.realms.StatusSeenBy newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        com_devlomi_fireapp_model_realms_StatusSeenByRealmProxyInterface realmObjectSource = (com_devlomi_fireapp_model_realms_StatusSeenByRealmProxyInterface) newObject;

        Table table = realm.getTable(com.devlomi.fireapp.model.realms.StatusSeenBy.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);

        // Add all non-"object reference" fields
        builder.addInteger(columnInfo.seenAtIndex, realmObjectSource.realmGet$seenAt());

        // Create the underlying object and cache it before setting any object/objectlist references
        // This will allow us to break any circular dependencies by using the object cache.
        Row row = builder.createNewObject();
        io.realm.com_devlomi_fireapp_model_realms_StatusSeenByRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.StatusSeenBy object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.seenAtIndex, rowIndex, ((com_devlomi_fireapp_model_realms_StatusSeenByRealmProxyInterface) object).realmGet$seenAt(), false);
        return rowIndex;
    }
