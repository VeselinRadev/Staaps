...
public class com_devlomi_fireapp_model_realms_UserRealmProxy extends com.devlomi.fireapp.model.realms.User
    ...
    static final class UserColumnInfo extends ColumnInfo {
        ...
        long lastTimeFetchedImageIndex;
        ...
        UserColumnInfo(OsSchemaInfo schemaInfo) {
            ...
            this.lastTimeFetchedImageIndex = addColumnDetails("lastTimeFetchedImage", "lastTimeFetchedImage", objectSchemaInfo);
        ...
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            ...
            dst.lastTimeFetchedImageIndex = src.lastTimeFetchedImageIndex;
    ...
    public long realmGet$lastTimeFetchedImage() {
        proxyState.getRealm$realm().checkIfValid();
        return (long) proxyState.getRow$realm().getLong(columnInfo.lastTimeFetchedImageIndex);
    }
    ...
    public void realmSet$lastTimeFetchedImage(long value) {
        if (proxyState.isUnderConstruction()) {
            ...
            final Row row = proxyState.getRow$realm();
            row.getTable().setLong(columnInfo.lastTimeFetchedImageIndex, row.getIndex(), value, true);
            return;
        }

        proxyState.getRealm$realm().checkIfValid();
        proxyState.getRow$realm().setLong(columnInfo.lastTimeFetchedImageIndex, value);
    }
    ...
    public static com.devlomi.fireapp.model.realms.User copy(Realm realm, UserColumnInfo columnInfo, com.devlomi.fireapp.model.realms.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        builder.addInteger(columnInfo.lastTimeFetchedImageIndex, realmObjectSource.realmGet$lastTimeFetchedImage());
    ...
    public static long insert(Realm realm, com.devlomi.fireapp.model.realms.User object, Map<RealmModel,Long> cache) {
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.lastTimeFetchedImageIndex, rowIndex, ((com_devlomi_fireapp_model_realms_UserRealmProxyInterface) object).realmGet$lastTimeFetchedImage(), false);
        return rowIndex;
    }
